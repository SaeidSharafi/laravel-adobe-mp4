export default {
    "app": {
        ...
        "data_table": {
            "active_filter": "{number} فیلتر فعال",
    ...
    "passwords": {
        "reset": "رمز عبور شما بروزرسانی شد!",
        "sent": "لینک بازنشانی گذرواژّ بریا شما ایمیل شد!",
        "throttled": "تعداد تلاش ها بیش از حد مجاز، لطفا مدتی صبر کرده و مجددا تلاش نمایید.",
        "token": "توکن بازنشانی رمز عبور معتبر نمیباشد.",
        "user": "کاربری با اطلاعات وارد شده یافت نشد."
    },
    "reports": {
        "category": "دسته بندی",
        "based_on": "بر اساس",
    ...
    "validation": {
        ...
        "enum": "مقدار انتخابی {attribute} نامعتبر میباشد.",
        ...
        "iran_phone": "{attribute} یک شماره همراه معتبر نیست.",
        "iran_mobile_phone": "{attribute} یک شماره همراه/تلفن معتبر نیست.",
        "custom": {
            "attribute-name": {
            ...
            "treatment": {
                "infertility": {
                    "serviceable": {
                        "invalid": "نوع خدمت نامعتبر میباشد"
                    }
                }
            }
        },
        ...
        "national_code.wrong": "کد ملی اشتباه است",
        "values": [],
