      ...
      <div class="px-2">
        <ul class="divide-y divide-gray-200">
          ...
          >
            ...
            >
              {{ column.translation ? column.translation : column.label }}
            </p>

            <button
              type="button"
              class="ltr:ml-4 rtl:mr-4 relative inline-flex shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-light-blue-500"
              :class="{
            ...
            >
              ...
              <span
                aria-hidden="true"
                :class="{
                  'rtl:-translate-x-5 ltr:translate-x-5': !column.hidden,
